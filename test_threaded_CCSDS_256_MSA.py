...
def MonteCarloRun(args):
    ...
    #print(chr(27) + "[2J")
    #print(debugString)
    print("THREAD %2.2f  |  Initial Errors:  %2d  |   Errors: %2d  |    Iteration: %3.2f" % (EbN, ErrorUncoded[p,k], ErrorMSA[p,k], k))
...
if __name__ == "__main__":
    ...
    pool = multiprocessing.Pool(processes=7,initializer = init_worker, initargs = (ErrorUncoded_shared,ErrorMSA_shared,MC,ArraySize))
    ...
    scio.savemat("LDPC_out_256_MSA.mat" ,{
        'EbN0s': EbNs,
